      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {session ? (
              <div className="flex items-center gap-3">
                <Link href="/dashboard/post-job">
                  <Button size="sm" variant="outline">Post a Job</Button>
                </Link>
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-slate-200 dark:border-slate-800 space-y-1">
            <Link href="/jobs" className="flex items-center px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors">
              Find Jobs
            </Link>
            <Link href="/companies" className="flex items-center px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors">
              Companies
            </Link>
            {session ? (
              <>
                <Link href="/dashboard" className="flex items-center px-3 py-2.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors">
                  Dashboard
                </Link>
                <button
                  onClick={() => signOut()}
