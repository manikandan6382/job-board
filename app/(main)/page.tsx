...
import { Briefcase, ArrowRight, Building2, Users, Sparkles } from "lucide-react"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-1.5 text-sm font-medium text-slate-300 mb-6">
              ...
              <span>{stats.jobs > 0 ? `${stats.jobs}+ Jobs Available` : "Start Your Job Search"}</span>
            </div>
            ...
            <p className="text-lg text-slate-400 mb-10 max-w-xl mx-auto">
              Browse thousands of jobs from top companies. Your next career move starts here.
            </p>
      ...
      <section className="py-16 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-2">Explore</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-3">Browse by Category</h2>
            <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto text-sm">Find jobs in your field of expertise</p>
          </div>
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="text-center">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300 group-hover:text-blue-600 transition-colors">{cat.name}</p>
      ...
      <section className="py-16 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            <div>
              <p className="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-2">Latest</p>
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">Recent Jobs</h2>
            </div>
          ...
          {jobs.length === 0 ? (
            <div className="text-center py-20 bg-white dark:bg-slate-950 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800">
              ...
              <Link href="/dashboard/post-job" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-10 sm:p-16 text-center overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-2xl sm:text-4xl font-bold text-white mb-4">Ready to Hire Top Talent?</h2>
              <p className="text-blue-100 mb-8 max-w-xl mx-auto text-sm sm:text-base">Post your job and reach thousands of qualified candidates today.</p>
              <Link href="/dashboard/post-job" className="inline-flex items-center gap-2 bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-xl font-bold text-base transition-colors shadow-lg">
